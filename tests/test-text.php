...
// Selector matcher.
$s = new Selector( array( '.brand', '#legal', 'div.footer-note', '[data-no-translate]', 'a[href^="tel:"]', '.parent .child' ) );
...
shdt_assert( $s->matches( 'b', array( 'class' => 'child' ) ), 'descendant uses last compound' );
